export default function Home() {
  return (
    <section id="home" className="bg-gradient-to-b from-gray-700 px-10 md:px-0 pt-70 mb-50 md:mb-0 md:pt-0 text-start flex flex-col md:flex-row items-center justify-center gap-8 w-full h-screen mx-auto">
