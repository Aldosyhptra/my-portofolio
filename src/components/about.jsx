export default function About() {
  return (
    <section id="about" className="bg-gray-900 w-full mx-auto py-10">
      <h2 className="text-3xl font-semibold mb-4 text-center">About Me</h2>
      <p className="text-gray-300 max-w-3xl text-justify mx-auto">Hi! Aku Aldo Syahputra, mahasiswa yang lagi menempuh studi di Universitas Achmad Yani Yogyakarta dengan jurusan Sistem Informasi dan saat ini lagi fokus banget memperdalam dunia Front-End Development. Aku suka bikin tampilan web yang nggak cuma enak dilihat, tapi juga nyaman dipakai.
